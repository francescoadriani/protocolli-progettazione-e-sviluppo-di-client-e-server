    ...
    public partial class FrmMain : Form
    {
        ...
        private double getNumberFromServer(double min, double max)
        {
            ...
            try
            {
                ...
                client.Send(Encoding.ASCII.GetBytes("GET[" + min.ToString("N", new CultureInfo("it-IT", false).NumberFormat) + ";" + max.ToString("N", new CultureInfo("it-IT", false).NumberFormat) + "]"));
